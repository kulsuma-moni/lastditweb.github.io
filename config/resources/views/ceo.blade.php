...
@section('content')
    ...
    <!--Start Leader area-->
    <section class="ceo_area_start" data-background="{{ asset('public/frontend/assets/images/leader__2.png') }}"  data-aos="fade-up">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12 col-12"></div>
                <div class="col-md-6 col-sm-12 col-12">
                    <div class="ceo_text_content">
                        <div class="ceo_spc_de">
                            <h4 data-aos="fade-up">Syed Delwar Hossain</h4>
                            <p data-aos="fade-down">Founder,Chairman & CEO at Delwar It </p>
                            <p>As one of the leading IT solution providers of Bangladesh,
                                ...
                                Global IT village by building a platform which serves business owners
    ...
    <!--End Leader area-->
        <!--Start Leader area For MOBILE-->
        <section class="mobile_leader-wrapper-area" data-aos="fade-up">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 col-sm-12 col-12">
                                <div class="leader-content">
                                    <h4>Syed Delwar Hossain</h4>
                                    <p>Founder,Chairman & CEO at Delwar It </p>
                                    <p>As one of the leading IT solution providers of Bangladesh,
                                        we are working with the vision of making the nation proficient in the
                                        Global ITvillage by building a platform which serves business owners
                                        as well as freelancers with comprehensive training for IT skills and
                                        professional enterprise solutions.Where we develop a progressive, empower and consumer focused corporate culture to growing market leadership along with the passion of corporate social responsibility to extend our leadership through performance.</p>
                                </div>
                            </div>
                        </div>
                    </div> 
        ...
        <!--End Leader area For MOBILE-->
    <!-- LEADER CAREER OVERVIEW AREA START-->
    <section class="ldr_overview_area">
        <div class="container">
            ...
            <div class="overview_content">
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12 col-12 m-auto d-flex justify-content-center flex-column order-md-1 order-sm-2 order-2">
                        <div class="overview_details content_box_shadow" data-aos="flip-up">
                            <p class="care_title">Master Trainer & Co-ordinator</p>
                            <p>Project: She Power Project , Department Of ICT , ICT Division</p>
                            <p>Year : Sep , 29 ,2018 – Nov , 5 ,2019</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-7 col-md-6 col-sm-12 col-12 d-flex justify-content-center flex-column order-md-2 order-sm-1 order-1">
                        <div class="overview_img text-center" data-aos="fade-down">
                            <img class="img-fluid" src="{{ asset('public/frontend/assets/images/she_power_project.png') }}" alt="she power project">
                        </div>
                    </div>
                </div>
            </div>
            <div class="overview_content">
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-6 col-sm-12 col-12">
                        <div class="overview_img text-center" data-aos="fade-up">
                            <img class="img-fluid" src="{{ asset('public/frontend/assets/images/ui_ux.png') }}" alt="Ui/UX project">
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12 col-12 m-auto d-flex justify-content-center flex-column">
                        <div class="overview_details content_box_shadow" data-aos="flip-down">
                            <p class="care_title">Co-ordinator</p>
                            <p>Project: Mobile Games UI & UX Design , ICT Division</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="overview_content">
                <div class="row">
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12 col-12 m-auto d-flex justify-content-center flex-column order-md-1 order-sm-2 order-2">
                        <div class="overview_details content_box_shadow" data-aos="flip-up">
                            <p class="care_title">District Co-ordinator : Web Design & Development</p>
                            <p>Venue : PDB High School, Sylhet</p>
                            <p>Project: Learning & Earning Development Project</p>
                            <p>Year: Nov 2016 - March 2017</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-7 col-md-6 col-sm-12 col-12 order-md-2 order-sm-1 order-1">
                        <div class="overview_img text-center" data-aos="fade-down">
                            <img class="img-fluid" src="{{ asset('public/frontend/assets/images/ledp.png') }}" alt="ledp project">
                        </div>
                    </div>
                </div>
            </div>
            <div class="overview_content">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12 col-12 m-auto d-flex justify-content-center flex-column">
                        <div class="overview_details content_box_shadow" data-aos="flip-down">
                            <p class="care_title">Trainer : Web Designer</p>
                            <p>Venue : TTC,Alampur,Sylhet,Bangladesh</p>
                            <p>Project: ঘরে বসে বড় লোক</p>
                            <p>Year: 2014</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- LEADER CAREER OVERVIEW AREA END-->
    <!-- Memory AREA START -->
    <section class="memoriy_image_gallery">
        <div class="container">
            <div class="title text-center" data-aos="fade-up">
                <h2>cherishable memories</h2>
                <div class="em-bar-main">
                    <div class="em-bar em-bar-big"></div>
                </div>
            </div>
            <div class="memories_img_gallery">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                        <div class="memory_galery_content" data-aos="fade-up">
                            <div class="mory_image">
                                <img class="img-fluid" src="{{ asset('public/frontend/assets/images/IMG-20210612-WA0026.jpg') }}" alt="sylhetHi-tech park">
                                <div class="zoom_btn">
                                    <a href="assets/images/IMG-20210612-WA0026.jpg">
                                        <i class="fas fa-search-plus"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="image_description d-flex justify-content-center flex-column">
                                <div class="title">
                                    <h5>Bangabandhu Sheikh Mujib Hi-Tech Park Sylhet visit and meeting with authority</h5>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                        <div class="memory_galery_content" data-aos="fade-down">
                            <div class="mory_image">
                                <img src="{{ asset('public/frontend/assets/images/FB_IMG_1611310931182.jpg') }}" alt="sylhetHi-tech park">
                                <div class="zoom_btn">
                                    <a href="assets/images/FB_IMG_1611310931182.jpg">
                                        <i class="fas fa-search-plus"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                        <div class="memory_galery_content" data-aos="fade-right">
                            <div class="image_description d-flex justify-content-center flex-column order-sm-1 order-2">
                                <div class="title">
                                    <h5>Bangabandhu Sheikh Mujib Hi-Tech Park Sylhet visit and meeting with authority</h5>
                                </div>
                                <div class="left_arrow right_arrow"></div>
                            </div>
                            <div class="mory_image order-sm-2 order-1">
                                <img src="{{ asset('public/frontend/assets/images/82595467_2511253482337093_6077068635791163392_n.jpg') }}" alt="sylhet Hi-tech park">
                                <div class="zoom_btn">
                                    <a href="assets/images/82595467_2511253482337093_6077068635791163392_n.jpg">
                                        <i class="fas fa-search-plus"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                        <div class="memory_galery_content" data-aos="fade-left">
                            <div class="image_description d-flex justify-content-center flex-column order-sm-1 order-2">
                                <div class="title">
                                    <h5>Bangabandhu Sheikh Mujib Hi-Tech Park Sylhet visit and meeting with authority</h5>
                                </div>
                            ...
                            <div class="mory_image order-sm-2 order-1">
                                <img src="{{ asset('public/frontend/assets/images/89693499_2568059970072481_7187847672181555200_n.jpg') }}" alt="sylhetHi-tech park">
                                <div class="zoom_btn">
                                    <a href="assets/images/89693499_2568059970072481_7187847672181555200_n.jpg">
                                        <i class="fas fa-search-plus"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                        <div class="memory_galery_content" data-aos="fade-up">
                            <div class="mory_image">
                                <img src="{{ asset('public/frontend/assets/images/IMG-20210612-WA0026.jpg') }}" alt="sylhetHi-tech park">
                                <div class="zoom_btn">
                                    <a href="assets/images/IMG-20210612-WA0026.jpg">
                                        <i class="fas fa-search-plus"></i>
                                    </a>
