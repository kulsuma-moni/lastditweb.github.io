...
@section('title','Delwarit | Edit Blog')
@section('content')
   <!-- Page Body Start-->
    ...
    <div class="page-body">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="header-title mb-4" style="float: left;">Edit Blog</h4>
                        <h4 class="header-title mb-4" style="float: right;"><a href="{{ route('index.blog') }}" class="btn btn-outline-primary">All Blog List</a></h4>
                    </div>
                </div>
                @if(session('success'))
                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control  @error('title') is-invalid @enderror" id="validationCustom01" type="text" required="" name="title" value="{{ $blog->title }}"> 
                                        @error('title')
                                    ...
                                    <select class="form-control @error('blogcate_id') is-invalid @enderror"  name="blogcate_id"  required="" value="{{ old('blogcate_id') }}" >
                                        ...
                                        <option value="{{ $blogcate->id }}" {{ $blogcate->id == $blog->blogcate_id ? 'selected' : ''}}>{{ $blogcate->name }}</option>
                                        @endforeach
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    ...
                                    <div class="form-group">
                                       <textarea style="height:300px" class=" @error('description') is-invalid @enderror" id="editor" name="description">{{ $blog->description }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
