            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                  <div class="blog_top_post_left blog_box">
                        <div class="blog_img">
                           <img src="{{ asset('public/frontend/assets/images/Rectangle 1763.png') }}" alt="">
                        </div>
                        <div class="blog_info">
                           <div class="titel">
                  ...
                  <div class="blog_top_post_right blog_box">
                     <div class="row">
                        <div class="col-md-5 py-0">
                           <div class="blog_img">
                              <img src="{{ asset('public/frontend/assets/images/Rectangle 1768.png') }}" alt="">
                           </div>
                        </div>
                        <div class="col-md-7">
                           <div class="blog_info">
            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="trendy_post_box trendy_box">
                     <div class="tp_img">
                        <img src="{{ asset('public/frontend/assets/images/Frame 17.png') }}" alt="">
                     </div>
                     <div class="blog_info">
                        <div class="titel">
                           <h3>Hac eget non odio donec vestibulum maecenas. Enim sed ullamcorper amet...</h3>
