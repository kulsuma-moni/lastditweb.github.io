                ...
                <div class="card-box">
                    ...
                    <form method="post" action="{{ route('store.course') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <textarea name="career" id="editor" class="form-control @error('career') is-invalid @enderror" cols="30" rows="10">{{ old('career') }}</textarea>
                                @error('career')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="number" id="course_fee" class="form-control @error('course_fee') is-invalid @enderror" name="course_fee"  value="{{ old('course_fee') }}">
                                @error('course_fee')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="text" id="total_class" class="form-control @error('total_class') is-invalid @enderror" name="total_class"  value="{{ old('total_class') }}">
                                @error('total_class')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
