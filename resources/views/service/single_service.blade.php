	...
	<section class="service-content-area">
		<div class="container">
					...
					<div class="service-sidebar">
						<div class="menu-service">
							<ul>
								...
								<li><a href="{{ route('single.service',$srv->slug) }}">{{ $srv->title }}</a>
								</li>
								@endforeach
							</ul>
						</div>
            ...
            @endif
               ...
               <input type="email" placeholder="Email Address" name="email" value="" class="form-control  " required  oninvalid="this.setCustomValidity('Enter Valid Email Here')" oninput="this.setCustomValidity('')">
				...
				<div class="col-lg-8">
					<div class="service-area">
						<div class="service-image">
							<img src="{{ asset('storage/app/public/'.$service->image) }}" alt="" class="img-fluid">
						</div>
